...
public class UISongUtils
{
    ...
    public static RadioButton[] getSongListsButtons()
    {
        ...
        {
            String currentListTag = "#" + (Utils.removeNLastCharactersInString(SongList.listNames[i], 4)).toLowerCase(); // Removes "List" from retrieved string
    ...
    public static void setSongListTextsOpacity(Text songText, int i) // UIUtils.java
    {
